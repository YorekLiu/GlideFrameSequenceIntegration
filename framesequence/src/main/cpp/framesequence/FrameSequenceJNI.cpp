...
#define JNI_PACKAGE "xyz/yorek/glide/framesequence"
static struct {
    jclass clazz;
    jmethodID ctor;
...
static jlong JNICALL nativeGetFrame(
        ...
        jobject bitmap, jint previousFrameNr, jint sampleSize) {
// update by yorek.liu >> end
    FrameSequenceState* frameSequenceState =
            reinterpret_cast<FrameSequenceState*>(frameSequenceStateLong);
    int ret;
    ...
    jlong delayMs = frameSequenceState->drawFrame(frameNr,
            (Color8888*) pixels, pixelStride, previousFrameNr, sampleSize);
    // update by yorek.liu >> end
...
static JNINativeMethod gMethods[] = {
    ...
    {   "nativeGetFrame",
        // update by yorek.liu >> begin
        "(JILandroid/graphics/Bitmap;II)J",
        // update by yorek.liu >> end
        (void*) nativeGetFrame
    },
    {   "nativeDestroyState",
